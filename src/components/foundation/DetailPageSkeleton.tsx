          ...
          <div className="flex flex-col gap-8 lg:flex-row">
            <div className="flex-1 space-y-4">
              <div className="flex items-center gap-4">
                <Skeleton className="h-16 w-16 rounded-xl bg-foreground/10" />
            ...
            <Skeleton className="h-40 w-40 rounded-full bg-foreground/10" />
          </div>
        </div>
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <Skeleton className="h-80 rounded-xl bg-foreground/10" />
          <Skeleton className="h-80 rounded-xl bg-foreground/10 lg:col-span-2" />
        </div>
      </div>
    </AppPage>
  );
