    ...
    <>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {isPep && (
                  <div className={cn(
                    ...
                    <Landmark className={cn('w-4 h-4', pepStatus === 'former_pep_in_monitoring' ? 'text-amber-300' : 'text-purple-400')} />
                    <span className={cn('text-sm font-medium', pepStatus === 'former_pep_in_monitoring' ? 'text-amber-200' : 'text-purple-300')}>
                ...
                {hasAdverseMedia && (
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/20">
                    ...
                    <span className="text-sm text-amber-300 font-medium">Medios adversos</span>
                  </div>
                )}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-6 min-w-0">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.05 }} className="glass rounded-xl p-6">
          <p className="text-xs text-gray-500 uppercase tracking-wide mb-3">Cobertura y Trazabilidad</p>
